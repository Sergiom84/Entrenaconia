-- ===========================================================================
-- INSERCIÓN DE EJERCICIOS OFICIALES PARA OPOSICIONES DE BOMBEROS
-- ===========================================================================
-- Descripción: Ejercicios oficiales según BOE + ejercicios preparatorios
-- Autor: Claude Code - Sistema de Oposiciones
-- Fecha: 2025-10-20
-- Version: 2.0.0 - Niveles corregidos (Principiante/Intermedio/Avanzado)
-- ===========================================================================

-- IMPORTANTE: Los niveles deben ser exactamente: Principiante, Intermedio, Avanzado
-- El backend mapea: principiante->Principiante, intermedio->Intermedio, avanzado->Avanzado

-- Limpiar datos previos para evitar duplicados
DELETE FROM app."Ejercicios_Bomberos";

-- ===========================================================================
-- EJERCICIOS OFICIALES (PRUEBAS DE EXAMEN)
-- ===========================================================================
...
('Técnica de crol - 400m', 'Principiante', 'Natación', 'Preparatoria', 'Completar', 'Completar', '4-6 series de 100m', 'Moderada', 60, 'Piscina', 'Enfocarse en brazada eficiente y respiración bilateral.'),
...
('Apnea estática', 'Principiante', 'Natación', 'Técnica', '60-90 seg', '60-90 seg', '3-5 series', 'Baja', 120, 'Piscina/Agua', 'Aumentar capacidad pulmonar. Progresión gradual.'),
...
('Trepa con piernas', 'Principiante', 'Fuerza', 'Técnica', 'Completar 6m', 'Completar 6m', '3-5 ascensos', 'Moderada', 120, 'Cuerda', 'Aprender técnica antes de intentar solo brazos.'),
...
('Dominadas asistidas banda', 'Principiante', 'Fuerza', 'Preparatoria', '8-12 reps', '8-12 reps', '3-4 series', 'Moderada', 90, 'Barra + banda elástica', 'Progresión para principiantes. Reducir asistencia gradualmente.'),
('Negativas de dominada', 'Principiante', 'Fuerza', 'Técnica', '5-8 reps lentas', '5-8 reps lentas', '3-5 series', 'Moderada', 120, 'Barra fija', 'Fase excéntrica controlada 5 segundos. Desarrolla fuerza.'),
...
('Técnica de salida', 'Principiante', 'Carrera', 'Técnica', '10-15 salidas', '10-15 salidas', '10-15 reps', 'Moderada', 60, 'Pista', 'Perfeccionar salida de pie. Primeros 20m críticos.'),
...
('Flexiones estándar', 'Principiante', 'Fuerza', 'Preparatoria', '10-15 reps', '10-15 reps', '3-5 series', 'Moderada', 90, 'Suelo', 'Técnica perfecta. Cuerpo recto. Codos 45 grados.'),
...
('Técnica de lanzamiento', 'Principiante', 'Fuerza', 'Técnica', '10-15 lanzamientos', '10-15 lanzamientos', '3-4 series', 'Moderada', 120, 'Balón medicinal', 'Aprender secuencia de movimiento. Transferencia de peso.'),
...
('Plancha abdominal', 'Principiante', 'Agilidad', 'Preparatoria', '60-120 seg', '45-90 seg', '3-4 series', 'Moderada', 90, 'Suelo', 'Core fuerte esencial para todas pruebas. Cuerpo alineado.'),
...
('Sentadillas peso corporal', 'Principiante', 'Fuerza', 'Preparatoria', '20-30 reps', '20-30 reps', '3-4 series', 'Moderada', 90, 'Suelo', 'Fuerza de piernas fundamental para carrera y pruebas físicas.');
