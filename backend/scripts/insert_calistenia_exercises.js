/**
 * Script para insertar ejercicios de calistenia desde CSV a Supabase
 * Archivo: insert_calistenia_exercises.js
 */
...
const exercisesData = [
  ...
  {id: 17, exercise_id: 'scap-pull-retracción-escapular', nombre: 'Scap pull (retracción escapular)', nivel: 'Básico', categoria: 'Tracción', patron: 'Control escapular', equipamiento: 'Barra', series_reps_objetivo: '3-4x6-10', criterio_de_progreso: 'Completa 10 reps con técnica perfecta en 2 sesiones seguidas antes de progresar.', progresion_desde: 'Dead hang (colgado pasivo)', progresion_hacia: 'Dominadas negativas', notas: 'Brazos estirados.'},
  {id: 18, exercise_id: 'pike-hold-básico', nombre: 'Pike hold básico', nivel: 'Básico', categoria: 'Empuje', patron: 'Empuje vertical (progresión)', equipamiento: 'Suelo', series_reps_objetivo: '3-4x20-30s', criterio_de_progreso: 'Sostén 30s con técnica perfecta en 2 sesiones seguidas antes de progresar.', progresion_desde: null, progresion_hacia: 'Pike push-up', notas: 'Cadera alta sobre manos.'},
  ...
  {id: 30, exercise_id: 'dominada-pronación-strict', nombre: 'Dominada pronación (strict)', nivel: 'Intermedio', categoria: 'Tracción', patron: 'Tracción vertical', equipamiento: 'Barra', series_reps_objetivo: '3-5x3-8', criterio_de_progreso: 'Completa 8 reps con técnica perfecta en 2 sesiones seguidas antes de progresar.', progresion_desde: 'Dominadas negativas', progresion_hacia: 'Dominada lastrada/archer', notas: 'Evita kipping.'},
  {id: 31, exercise_id: 'chin-up-supinación-strict', nombre: 'Chin-up (supinación strict)', nivel: 'Intermedio', categoria: 'Tracción', patron: 'Tracción vertical', equipamiento: 'Barra', series_reps_objetivo: '3-5x4-10', criterio_de_progreso: 'Completa 10 reps con técnica perfecta en 2 sesiones seguidas antes de progresar.', progresion_desde: 'Dominadas negativas', progresion_hacia: 'Chin-up lastrado', notas: 'Pecho a la barra.'},
  ...
  {id: 52, exercise_id: 'one-arm-chin-up-asistneg', nombre: 'One-arm chin-up (asist./neg.)', nivel: 'Avanzado', categoria: 'Tracción', patron: 'Tracción unilateral', equipamiento: 'Barra', series_reps_objetivo: '6-10x1-3/lado', criterio_de_progreso: 'Completa 3/lado con técnica perfecta en 2 sesiones seguidas antes de progresar.', progresion_desde: 'Archer pull-up', progresion_hacia: 'One-arm chin-up strict', notas: 'Usa banda/asistencia.'},
  ...
  {id: 55, exercise_id: 'front-lever-advanced-tuckstraddle', nombre: 'Front lever – advanced tuck/straddle', nivel: 'Avanzado', categoria: 'Tracción', patron: 'Estático', equipamiento: 'Barra/Anillas', series_reps_objetivo: '6-10x5-15s', criterio_de_progreso: 'Sostén 15s con técnica perfecta en 2 sesiones seguidas antes de progresar.', progresion_desde: 'Front lever tuck', progresion_hacia: 'Front lever full', notas: 'Depresión escapular.'},
  {id: 56, exercise_id: 'back-lever-advanced-tuckstraddle', nombre: 'Back lever – advanced tuck/straddle', nivel: 'Avanzado', categoria: 'Empuje', patron: 'Estático', equipamiento: 'Anillas/Barra', series_reps_objetivo: '6-10x5-15s', criterio_de_progreso: 'Sostén 15s con técnica perfecta en 2 sesiones seguidas antes de progresar.', progresion_desde: 'Back lever tuck', progresion_hacia: 'Back lever full', notas: 'Codos bloqueados.'},
...
async function insertCalisteniaExercises() {
  const client = await pool.connect();
  
  try {
    console.log('🚀 Iniciando inserción de', exercisesData.length, 'ejercicios de calistenia...');
    ...
    for (const exercise of exercisesData) {
      ...
      await client.query(insertQuery, [
        ...
        exercise.series_reps_objetivo,
        exercise.criterio_de_progreso,
      ...
      inserted++;
      if (inserted % 10 === 0) {
        console.log(`✅ Insertados ${inserted}/${exercisesData.length} ejercicios...`);
      }
    }
