const BodyMeasurementsStep = ({ formData, onInputChange }) => {
  ...
  return (
    <div className="space-y-8">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-accent-400 mb-2">Medidas Corporales (Opcional)</h2>
      ...
      <div className="bg-gray-700/30 rounded-lg p-6 border border-gray-600">
        <h3 className="text-lg font-semibold text-accent-400 mb-4">¿Por qué necesitamos estas medidas?</h3>
